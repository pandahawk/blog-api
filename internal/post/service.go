...
type Service interface {
	...
	CreatePost(req *dto.CreatePostRequest) (*model.Post, error)
	GetPosts() ([]*model.Post, error)
	UpdatePost(id uuid.UUID, req *dto.UpdatePostRequest) (*model.Post, error)
...
func (s service) CreatePost(req *dto.CreatePostRequest) (*model.Post, error) {
	//TODO implement me
	panic("implement me")
}
...
func (s service) UpdatePost(id uuid.UUID, req *dto.UpdatePostRequest) (*model.Post, error) {
	//TODO implement me
	panic("implement me")
}
